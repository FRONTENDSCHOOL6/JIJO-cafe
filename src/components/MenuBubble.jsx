...
function MenuBubble({ children }) {
  ...
  return (
    <motion.div initial={{ x: 0, y: -181 }} animate={{ x: 0, y: 0 }} transition={{ duration: 0.7 }} className="relative">
      <div className="leading-tight text-center bg-primary p-jj_50 text-jj_34">{children}</div>
