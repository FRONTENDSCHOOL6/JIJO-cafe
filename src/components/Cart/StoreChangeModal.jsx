      ...
      <div className="fixed left-0 top-0 z-[10001] w-full h-screen bg-[rgba(0,0,0,0.5)] flex justify-center items-center">
        <div ref={modalRef} className="w-[31.25rem] bg-white p-6">
          ...
          <div className="mt-5 flex justify-center gap-4">
            <Button
              onClick={handleClose}
              className="border border-secondary w-[7.5rem] hover:bg-secondary hover:text-white cursor-pointer">
              취소
            </Button>
            <Button className="bg-primary hover:bg-[#C7B08E] w-[7.5rem] cursor-pointer">
              매장변경
            </Button>
          </div>
        </div>
