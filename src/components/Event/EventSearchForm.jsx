function EventSearchForm({searchText, handleInputSearch, handleSearchResult}) {
  return (
    <form>
      <div className="flex gap-2 my-10">
        ...
        <button
          ...
          type="submit"
          value="검색"
          className="bg-primary hover:bg-[#C7B08E] px-5 py-[0.625rem] mobile:w-full font-medium h-[2.8125rem] rounded-sm">
          검색
        </button>
      </div>
    </form>
