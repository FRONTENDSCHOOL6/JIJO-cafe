            ...
            <SwiperSlide key={item.id}>
              {
                <div className="bg-white rounded-2xl">
                  ...
                  <div className="p-3 shadow-lg bg-slate-200 rounded-b-2xl">
                    <h5 className="overflow-hidden font-medium text-jj_24 text-ellipsis break-keep line-clamp-1">{item.title}</h5>
                    <del className="block text-gray-400 text-jj-18">{item.price}</del>
