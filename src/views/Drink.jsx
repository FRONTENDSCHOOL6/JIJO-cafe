...
function Drink() {
  return (
    <div className="">
      ...
      <MenuBubble>
        <strong>깊고 부드러운 커피 맛의 비밀</strong><br />
        행복을 선사하는 다양한 음료
      </MenuBubble>
      <section className="mx-auto max-w-7xl flex justify-between items-center gap-[3.125rem]">
        <div>
          ...
          <h2 className="text-jj_60 font-bold break-keep leading-tight">풍요로운 가을이 만든 달콤함</h2>
          <div className="text">
            <p className="title text-jj_22 border-b pb-5">청송 사과 한 잔, 보름달 한 상</p>
            <p className="desc text-[#1c1c1b] opacity-70 pt-5">가을이 키운 달콤한 청송 사과 신메뉴와<br/> 가을을 닮은 풍요로운 보름달 신메뉴 출시!<br/> 지금 바로 가까운 메가MGC커피에서 만나보세요!</p>
          </div>
        </div>
        <figure className="shrink-0">
          <img src="/src/assets/images/menu/drink/drink_image01.jpg" alt="가을이 키운 달콤한 청송사과 한 잔" />
        </figure>
      </section>
