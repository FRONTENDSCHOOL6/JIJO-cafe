        ...
        <div className="footerLeft w-1/2 tablet:w-full mobile:w-full">
          <div className="footerLogoArea flex items-center tablet:justify-center mobile:justify-center">
            <figure className="footerLogo">
              <img src="/src/assets/images/logoTitle_white.svg" alt="카페지조 로고" />
            </figure>
          ...
          <ul className="flex justify-between text-white font-thin">
            <li>
              ...
              <ul className="flex flex-col gap-2 mt-3 text-jj_14">
                <li><a href="/menu/drink" className="opacity-70 hover:opacity-100 hover:underline">음료</a></li>
                <li><a href="/menu/food" className="opacity-70 hover:opacity-100 hover:underline">푸드</a></li>
                <li><a href="/menu/product" className="opacity-70 hover:opacity-100 hover:underline">상품</a></li>
              </ul>
            </li>
            <li>
              <strong className="text-light text-jj_17">매장</strong>
              <ul className="flex flex-col gap-2 mt-3 text-jj_14">
                <li><a href="/findStore" className="opacity-70 hover:opacity-100 hover:underline">매장찾기</a></li>
              </ul>
            </li>
            <li>
              <strong className="text-light text-jj_17">지조소식</strong>
              <ul className="flex flex-col gap-2 mt-3 text-jj_14">
                <li><a href="/bbs/notice" className="opacity-70 hover:opacity-100 hover:underline">공지사항</a></li>
                <li><a href="/bbs/faq" className="opacity-70 hover:opacity-100 hover:underline">이벤트</a></li>
                <li><a href="/bbs/customer" className="opacity-70 hover:opacity-100 hover:underline">FAQ</a></li>
                <li><a href="/bbs/event" className="opacity-70 hover:opacity-100 hover:underline">고객의 소리</a></li>
              </ul>
            </li>
          </ul>
        </div>
